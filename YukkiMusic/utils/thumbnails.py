...
# threshold to get just the signature
        retval, thresh_gray = cv2.threshold(gray, thresh=100, maxval=0, type=cv2.THRESH_BINARY)
...
# get the thresholded crop
        retval, thresh_crop = cv2.threshold(crop, thresh=200, maxval=0, type=cv2.THRESH_BINARY)
